...
const SpotifyTopList = () => {
  ...
  let playlistUrl = 'https://open.spotify.com/user/rafe1703?si=68f2f1a3eeef45ab'
...
//   console.log(playlist.playlistName)
  ...
  return (
    <a href={playlistUrl} style={{color:'black', textDecoration:'none'}} target='_blank' rel="noopener noreferrer">
    <div className='playlistContainer'>
        ...
        <div className='playlistCover'><img src={playlistCover} alt='Playlist Cover'/></div>
        <div className='playlistInfo'>
            <div className='playlistHeader'>My Playlist</div>
            <div className='playlistName'><a target='_blank' rel="noopener noreferrer" href={playlistUrl}>{playlistName}</a></div>
